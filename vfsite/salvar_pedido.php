...
// 1. Conexão com o banco de dados (Ajustado para as credenciais oficiais do InfinityFree)
$host = "sql210.infinityfree.com";
$db_name = "if0_42420474_totem_db"; // O nome do banco de dados está correto
$username = "if0_42420474";         // CORREÇÃO: Adicionado o "0" aqui (if0_...)
$password = "pasapore2026";   // CORREÇÃO: Coloque aqui a senha do seu painel do InfinityFree (gerada automaticamente por eles)
...
try {
    ...
    // Sanitização do nome do cliente (usado em ambas as tabelas)
    $clienteNomeSanitizado = htmlspecialchars(strip_tags($data['cliente_nome']));
    ...
    // 6. Insere os itens do pedido na tabela 'itens_pedido' (Incluindo o cliente_nome presente no banco)
    $queryItem = "INSERT INTO itens_pedido (pedido_id, item_nome, preco_unitario, quantidade, cliente_nome) 
                  VALUES (:pedido_id, :item_nome, :preco_unitario, :quantidade, :cliente_nome)";
